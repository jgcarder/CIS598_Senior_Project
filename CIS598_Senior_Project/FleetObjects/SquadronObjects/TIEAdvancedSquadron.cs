...
{
    /// <summary>
    /// The class for the TIE Advanced
    /// </summary>
    public class TIEAdvancedSquadron : Squadron
    {
        ...
        /// <summary>
        /// The constructor for the squadron
        /// </summary>
        /// <param name="id">the id for the squad</param>
        ...
        public TIEAdvancedSquadron(int id, ContentManager content)
        {
            ...
            Image = content.Load<Texture2D>("TIEAdvancedToken");
